...
export default function Projects() {
  ...
  return (
    <>
      <Head>
        <title>Fabricio Cuevas | Projects</title>
      </Head>
      ...
      >
        <div className="grid grid-cols-3 gap-2 md:grid-cols-4 md:gap-4 my-5 container mx-auto xl:px-20">
          <div className="col-span-3 md:col-span-4 aspect-2/1 md:aspect-auto flex justify-between items-center bg-[#50638c] dark:bg-[#111827] rounded-3xl overflow-hidden">
          ...
          <div className="col-span-3 md:col-span-4 bg-[#50638c] dark:bg-[#111827] h-16 rounded-3xl overflow-y-hidden relative">
