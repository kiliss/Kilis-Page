...
export default function LanguagueCard() {
  ...
  return (
    <div
      ...
      className="flex flex-col justify-center items-center bg-[#50638c] dark:bg-[#111827] rounded-3xl relative overflow-hidden col-span-1 aspect-square shadow-sm cursor-pointer hover:scale-[103%] transition duration-300 ease-in-out"
    >
